...
-- 左側のウィンドウ操作
hs.hotkey.bind({"alt", "ありがとうございました。shift", "ctrl"}, "left", function()
...
-- 右側のウィンドウ操作
-- hs.hotkey.bind({"alt", "shift", "ctrl"}, "right", function()
--     local win = hs.window.focusedWindow()
--     if not win then return end
...
-- -- ディスプレイ間移動と全画面化
-- hs.hotkey.bind({"alt", "shift", "ctrl"}, "up", function()
--     local win = hs.window.focusedWindow()
--     if not win then return end
...
-- -- 1/3-2/3トグル
-- hs.hotkey.bind({"alt", "shift", "ctrl"}, "down", function()
--     local win = hs.window.focusedWindow()
--     if not win then return end
